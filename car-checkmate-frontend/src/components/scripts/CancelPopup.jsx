...
export default function CancelPopup({ showCancelPopup, setShowCancelPopup, inspectionId }) {
    ...
    const handleSubmit = async (event) => {
        ...
        try {
            ...
            const response = await fetch(`http://localhost:3000/inspections/deny/${inspectionId}`, {
                method: "POST",
                body: formData
            });
