...
//   }
    ...
    const carPhotosArray = Array.isArray(carData.carPhotos) ? carData.carPhotos : [];
                                ...
                                <div className="additional-images-container">
                                    <div className="photo-frame">
                                        {trimmedFilePathsArray.map((image, index) => (
                                            ...
                                            >
                                                <img src={trimmedFilePathsArray[index]} alt={`Car Image ${index + 1}`} />
                                            </div>
                                        ))}
                            ...
                            <div className="details-section">
                                <div className="tab-content">
                                    <div className="car-details">
                                        <h2> {carData.make} {carData.model} {carData.year}</h2>
                                        <ul>
                                            <li><strong>Suburb:</strong> {carData.suburb}</li>
                                            <li><strong>Odometer:</strong> {carData.odometer}</li>
                                            <li><strong>Transmission:</strong> {carData.transmission}</li>
                                            <li><strong>Engine Type:</strong> {carData.engineType}</li>
                                            <li><strong>Fuel Type:</strong> {carData.fuelType}</li>
                                            <li><strong>Body Type:</strong> {carData.bodyType}</li>
                                        </ul>
                                    </div>
                                </div>
                            </div>
