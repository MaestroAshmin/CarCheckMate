...
router.get(
  "/pending-inspections/:id",
  inspectionController.getPendingInspectionsForSeller
);
...
router.get(
  "/upcoming-buyer/:id",
  inspectionController.getUpcomingInspectionsBuyer
);
...
router.get(
  "/upcoming-seller/:id",
  inspectionController.getUpcomingInspectionsSeller
);
...
router.get(
  "/past-seller/:seller_id",
  inspectionController.getPastInspectionsSeller
);

// Route to allow mechanics to view upcoming unclaimed inspections
router.get(
  "/upcoming-unclaimed-mechanic",
  inspectionController.getUpcomingUnclaimedInspectionsForMechanic
);

// Route to allow mechanics to accept an inspection
router.post(
  "/accept-inspection-mechanic/:inspectionId",
  inspectionController.acceptInspectionMechanic
); //git

// Route to allow mechanics to view sorted inspections
router.get(
  "/inspections-accepted-mechanic/:mechanicId",
  inspectionController.getAcceptedInspectionsMechanic
);
...
router.post("/sendEmailToSeller/:id", inspectionController.sendEmailToSeller);
router.post("/sendEmailToBuyer/:id", inspectionController.sendEmailToBuyer);
